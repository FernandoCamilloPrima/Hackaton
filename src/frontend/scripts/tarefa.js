            ...
            <div class="card mb-3" style="background-color: #eeeeee">
                <div class="card-body">
                    <div style="display: flex; align-items: center; justify-content: space-between;">
                        ...
                        <div class="text-end">
                            <a data-codigo=${aluno.codigo} data-situacao="${aluno.situacao}" href="javascript:void(0)" onclick="alternar(this)" role="button" class="btn btn-sm btn-${obterClasseSituacao(aluno.situacao)} btn-situacao">
